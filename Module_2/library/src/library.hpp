...
public:
    ...
    */
    Book FindBookByName(std::string const& target) const;
    ...
    */
    std::vector<Book> FindBooksByAuthor(std::string const& target) const;
    ...
    */
    Customer FindCustomer(std::string const& target) const;
