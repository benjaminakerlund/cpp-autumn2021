...
public:
    ...
    * This function should not alter the Customer object's state, in other words the function should be const.
    */
    int GetLoanAmount() const; //Run through vector of books and count them. Or just size of vector :DD
    ...
    * This function should not alter the Customer object's state, in other words the function should be const.
    */
    std::vector<Book> GetLoans() const; //Return the private vector of books
